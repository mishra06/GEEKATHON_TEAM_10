...
console.log("kuch",fullName,city,state,add,phoneNumber,email,
    ...
    let file = document.querySelector("#down")
...
function language(){
    ...
    if(Languages != ""){
        sixDiv.append(hr11,langLogo , lang);
        file.append(sixDiv);
...
function skill(){
    ...
    skil.innerText = ":- "+"  "+skils+" , "+skils2+" , "+skils3+" , "+skils4;
    skilLOgo.innerText = "SKILS"

    if(skilCount == 1){
        fifthDiv.append(hr10 ,skilLOgo);
        skilCount++;
    }
    if(skils != ""){
...
function jobExp(){
    ...
    experinse3.className = "dateText"
    
    let experinse6 = document.createElement('span')
    experinse6.style.fontSize = "10px"
    ...
    experinse.innerText = ":- "+"  "+exp+" , "+exp2+" , "+exp5;
    experinse3.innerText = " "+exp3+" "+exp4;
    experinse6.innerText = " "+exp6;
    history.innerText = "EMPLOYMENT HISTORY"
    let flg = 1;
